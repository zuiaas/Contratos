					...
					>
						<Routes>
								...
								<ProtectedRoute>
									<div className="max-w-4xl">
										<div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100">
											<h1 className="text-3xl font-bold text-slate-800 mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500 w-fit">
							...
							<Route path="/planos-pagamentos/cadastro" element={
								<ProtectedRoute>
									<div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
										<h2 className="text-2xl font-bold text-slate-800 mb-4">Cadastro de Plano de Pagamento</h2>
										<p className="text-slate-500">Formulário de cadastro será implementado aqui.</p>
									</div>
								</ProtectedRoute>
							} />
							<Route path="/planos-pagamentos/editar/:id" element={
								<ProtectedRoute>
									<div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
										<h2 className="text-2xl font-bold text-slate-800 mb-4">Edição de Plano de Pagamento</h2>
										<p className="text-slate-500">Formulário de edição será implementado aqui.</p>
									</div>
								</ProtectedRoute>
							} />
						</Routes>
